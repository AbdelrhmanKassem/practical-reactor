...
public class c1_Introduction extends IntroductionBase {
    ...
    public void nothing_happens_until_you_() throws InterruptedException {
        ...
        // Adding to the List is done asynchronously, so assertEquals could be called before all elements of the flux
        // have been added to the List, causing the test to fail.
